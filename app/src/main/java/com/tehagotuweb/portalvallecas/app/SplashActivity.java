...
public class SplashActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Este m�todo meter� una latencia en el splash para mantenerlo en pantalla y lanzar� el intent a la segunda actividad
        meterLatencia();
    ...
    private void meterLatencia()
    {
        Thread timer = new Thread(){
            public void run(){
                // Como la ejecuci�n de un activity no contempla el metodo sleep, es decir retrasar un proceso de renderizado,
